...
namespace RaceEngineerPlugin {
    ...
    public class SettingsInternal {
        ...
        public SettingsInternal() {
            ...
            TyrePresInfo = new string[] { "Min", "Max", "Avg", "MinColor", "MaxColor", "AvgColor", "Color" };
            TyreTempInfo = new string[] { "Min", "Max", "Avg", "MinColor", "MaxColor", "AvgColor", "Color" };
            BrakeTempInfo = new string[] { "Min", "Max", "Avg", "MinColor", "MaxColor", "AvgColor", "Color" };
